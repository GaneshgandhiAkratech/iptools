  ...
  <div class="col-4">
    <div class="info-box animated bounceInLeft">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number"><?php echo $total_live_list; ?></span>
      </div>
    </div>
  </div>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title"><i class="fa fa-list"></i> Green Top Crawled Table</h3>
        <div class="card-tools">
          <a href="<?php echo base_url('greentop') ?>?live_list=1"><i class="fa fa-location-arrow"></i> View Live
            Product&nbsp;&nbsp;&nbsp;</a>
